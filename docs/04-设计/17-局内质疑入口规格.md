...
| `lb_str_challenge_disabled_first` | 第一手还没人出过牌 | 第一手禁用态 |
| 质疑 / 相信 | 可见字 **质疑** / **相信** | 按钮面。本线不另强制第三套 str |
...
| F17-11 | **质疑未揭** | 点质疑却当相信：卸入口自出牌、跳过 ChallengeCommit / 不等 ack / 不进 18（**SUPERSEDE** 旧 F17-11「真当过」） |
...
| F17-21 | **相信仍揭牌** | 点相信 / 超时却进 Reveal / 翻池 / 进 18 |
| F17-22 | **入口仍真假过** | 入口仍为「真\|假\|过」三键或保留可点 `_pass` 第三主钮（未改为质疑\|相信） |
...
- [ ] @LiarBar测试 F17-1～24 可抄（含 **真假当入口** / **相信仍揭牌** / **质疑未揭** / **入口仍真假过** / **质疑入口看不见** / **能跳过出牌**）；合入 ≠ 终验  
