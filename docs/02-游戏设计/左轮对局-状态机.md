...
| **v1.1.3** | PM reject：锁 id=**doubt\|believe**（btn/str/art）；**RESTORE** true/false（deprecated entry）；废 commit/trust 文案键（免撞 SFX）；S18-14/15→believe/doubt 键名；disabled_first 非 tip 主读 |
