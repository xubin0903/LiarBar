...
|----|------|
| 文档版本 | **v0.1.1**（会签稿） |
| 状态 | **2026-09-21 Soft×1 / Slam×3 防塌缩会签** · 会签草案 · **合入 ≠ 终验**
| 主笔 | 策划（`feat/design`） |
...
| **Slam×3** | 上家 `style=SLAM` 或强可疑（`S_raw` 高档：SLAM+count3 或高揭假史） | 质疑率 **Karen 高 / Shark 中 / Timid 低**；目标比 **Karen : Timid ≈ 3 : 1**（窗 **2.5～3.5**）；Shark 夹中 | Slam 窗三人格同率；或再塌成二值必疑/必信 |
...
| U-AI-04c | **Slam×3** 夹具（SLAM/强可疑） | Karen 质疑率≈Shark×中≈Timid×3 窗 | 同率或二值塌缩 = **AI假决策** |
...
| S-AI-09 | Slam×3 夹具 | Karen高/Shark中/Timid低≈3× | AI假决策 |
...
| **v0.1.1** | 2026-09-21 | **Soft×1 / Slam×3 防塌缩**：Soft 三人格多数信；Slam Karen高/Shark中/Timid低≈3×；AI假决策口径扩；U-AI-04b/c · S-AI-08/09 |
