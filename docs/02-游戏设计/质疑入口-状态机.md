...
| 项 | 内容 |
|----|------|
| 文档版本 | **v0.2.7**（入口 id=doubt\|believe 锁；胜负 **SUPERSEDED** → 对局 **v2.0.3**；F2 全员可见；**R2 废第一手禁质疑**） |
...
上一手 PlayLanded 且 hand>0（**含本轮第一手**）→ 必须过本门：
...
几何 / 全员层认 **17 / 18**（见 UI；**本文件不发明 vp**）。上家落地后下家须先 **质疑\|相信**（**含本轮第一手**；2026-09-15 废旧 G-Q6「第一手不可质疑」）。细则见 [对局-状态机 §1.2 / §1.3](./对局-状态机.md)。
...
| **第一手须可质疑**（G-Q6 翻 · R2） | 本轮第一手 PlayLanded 后下家 **必须进** AwaitChallenge。跳过 / `isFirstOfRound` 挡门 = **第二人不可质疑第一手** |
| **hand==0（打光）者不被质疑、也不质疑** | PlayLanded 后 `hand==0` → **RoundWin→RedealAll**，**禁** AwaitChallenge。打光者钮可点、或下游仍开他这手 = **打光者仍被质疑 / 仍能点质疑** |
| PlayLanded ∧ hand>0 → AwaitChallenge（**含本轮第一手**） | hand>0 即进；**废**「非第一手」条件 |
...
| **AwaitChallenge** | `TURN`（下家） | **池上该手堆保持**；**质疑·相信同层二键**；倒计时环可选 | 点质疑（ChallengeCommit）；或相信（Trust/Pass）；或超时并入相信 | hand==0 进来；尚无上家本手进来；旧四拍/弱 CTA 并行；问卷式多步；**把质疑当成相信/过**；**首出落地后跳过本态** |
...
| Q02 | PlayLanded | `PILE_FORMED` | 权威已接受 **且** `hand.count > 0`（**含本轮第一手**） **且** `lastPlay.actor` 本手未打光 | **AwaitChallenge** | 播 `lb_sfx_challenge_enter`（非静默）。开 **10s** 窗。出质疑·相信同层二键。**废**「第一手跳过」 |
| Q03 | — | — | **（并入 Q02）** 原「非第一手才进」条件已废；见 Q02 | — | 保留行号防断链；勿再实现「非第一手」分支 |
...
| Q07 | ChallengeCommit | `AUTHORITY_REJECT` | 非法靶 / 尚无上家本手 / 打光者 / 命尽者 / 竞态 | AwaitChallenge（窗未尽）或 Pass（窗尽） | **必须**出「质疑未生效」。已揭的牌 **盖回**。不进裁定。**不得**把「本轮第一手」当非法靶 |

`canChallenge`（写死；**废**「非第一手才进窗」）：

```
canChallenge = current.ALIVE                      // lives>0；命尽淘汰者不质疑
               AND lastPlay != null
               AND 本轮已有上家本手（含本轮第一手落地）
...
| ID | 短句（写死） | 不过 |
|----|----------------|------|
| **S17-1** | **第二人不可质疑第一手** | 本轮第一手 PlayLanded 后下家 **不进** AwaitChallenge / 质疑键禁用；与对局 **S18-6** 同句（语义翻） |
...
| **v0.2.7** | 2026-09-15 | **R2**：废第一手禁质疑；Q02 含第一手→AwaitChallenge；S17-1=第二人不可质疑第一手；指针对局 v2.0.3 |
...
*维护人：策划文档岗 · 2026-09-15 · docs + string.json · v0.2.7 · 入口=质疑\|相信 · R2 废第一手禁质疑 · 胜负 SUPERSEDED by 对局 v2.0.3 · 合入 ≠ 终验*

### v0.2.7（2026-09-15）
- **R2**：废「第一手不可质疑」；Q02 含本轮第一手 → AwaitChallenge；Q03 并入；S17-1 语义翻为「第二人不可质疑第一手」（对齐对局 S18-6 / #191）。
- **R1** 开牌真牌面指针见对局 §1.3 / S18-24（本文件不重复 vp）。
