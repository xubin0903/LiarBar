...
> **废** 本文 RoundWin→RedealAll、3 命主胜负、打光=本轮胜旧句（#160/#163）。  
> 下文仅作历史 UI 拍（飞出/落池）参考；胜负 / 打光门 / 开枪 **以左轮为准**。合入 ≠ 终验 · 会签前零 ets。

# 出牌扣牌 · 状态机（第1节锁 + AwaitChallenge 入口 + 轮胜重发）

| 项 | 内容 |
|----|------|
| 文档版本 | **v0.4.0**（**SUPERSEDED** → 左轮 v1.1.0） |
...
| 2026-09-14 | **SUPERSEDED** → 左轮对局-状态机 v1.1.0；废 RoundWin/3命 | 顶栏横幅 | 制作人 / Aron | **待会签** |

---

*维护人：策划文档岗 · 2026-09-14 · docs only · v0.4.0 轮胜重发 · **SUPERSEDED by 左轮** · 会签前零 ets · 合入 ≠ 终验*
