...
|----|------|
| 文档版本 | **v2.0.3** |
| 状态 | **2026-09-14 PM/Aron 锁：废左轮；lives_default=3 烛；揭牌输家直接熄1烛；熄尽淘汰；末存活胜** · **F2 质疑/揭牌全员可见** · **R1 开牌真牌面 / R2 第二人可质疑第一手（2026-09-15 Rebuild）** · 会签草案 · **合入 ≠ 终验** · 会签前零 ets |
...
> **R1 开牌真牌面（2026-09-15 Rebuild）**：`lb_cmp_reveal_stage` / 揭牌 faceUp **必须**用上家本手真实 `lastPlayRanks`（或等价真源）；**禁**用本轮宣称/claim 填充假面。真/假裁定仍对照宣称，但**看见的牌**是真出牌。  
> **R2 第二人可质疑第一手（2026-09-15 Rebuild）**：本轮 **第一手 PlayLanded** 后，下家 **必须**进 `TrustOrChallenge`（质疑\|相信）。**废** `isFirstOfRound` /「第一手不可质疑」挡门。尚无任何人出牌时仍无可质疑靶（disabled）。  
...
## 1.3 R1 开牌真牌面（Reveal · 2026-09-15 Rebuild）

**写死：** `CHALLENGE_RITUAL` / Reveal 下发与舞台 faceUp **= 上家本手真实打出牌**（`lastPlayRanks` / `lastPicked` 或权威等价真源）。

| 必须 | 禁（=失败） |
|------|-------------|
| 揭开看见的点数 = 上家实际打出 | 用本轮宣称点数填充 / claim fallback 冒充出牌（**开牌假面**） |
| 真/假裁定仍对照宣称（含 Joker 除外） | 把「看见的假面」当成裁定输入却与真出牌脱节 |

交叉 [18](../04-设计/18-局内开牌区规格.md)；失败短句 **S18-24**。
...
| **S18-24** | **开牌假面** | `lb_str_reveal_claim_face` | 揭牌舞台用本轮宣称/claim 填充牌面，**非**上家真实 `lastPlayRanks`；看见表=宣言假面 |
