...
|----|------|
| 文档版本 | **v2.0.1** |
| 状态 | **2026-09-14 PM/Aron 锁：废左轮；lives_default=3 烛；揭牌输家直接熄1烛；熄尽淘汰；末存活胜** · **F2 质疑/揭牌全员可见** · 会签草案 · **合入 ≠ 终验** · 会签前零 ets |
| 范围 | 整局主链 + **打光/hand-empty ≥3/=2** + **TrustOrChallenge 入口文案** + **命数3烛 / PenaltyExtinguish1** + **F2 全员可见（质疑气泡/荷官进窗/揭牌舞台/裁定结果）**。**废** RevolverGun / 膛位 HUD / 真弹·空膛轮盘 / 开枪结算。**废** develop 左轮真源与「真弹即死 / lives_default=1」。旧 [左轮对局-状态机](./左轮对局-状态机.md) 已 SUPERSEDED |
...
仍锁：发5、MAX_PLAY=3、第一手不可质疑、Joker符合指定；pool / reveal 拍 **不变**；入口 doubt\|believe；hand-empty ≥3/=2；**质疑/揭牌桌上全员可见**。  
...
1. 非第一手必须先过 **质疑 \| 相信**（U04 / U20 / S18-6）——不变。  
