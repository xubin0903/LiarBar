...
|----|------|
| 文档版本 | **v2.0.0** |
| 状态 | **2026-09-14 PM/Aron 锁：废左轮；lives_default=3 烛；揭牌输家直接熄1烛；熄尽淘汰；末存活胜** · 会签草案 · **合入 ≠ 终验** · 会签前零 ets |
| 范围 | 整局主链 + **打光/hand-empty ≥3/=2** + **TrustOrChallenge 入口文案** + **命数3烛 / PenaltyExtinguish1**。**废** RevolverGun / 膛位 HUD / 真弹·空膛轮盘 / 开枪结算。**废** develop 左轮真源与「真弹即死 / lives_default=1」。旧 [左轮对局-状态机](./左轮对局-状态机.md) 已 SUPERSEDED |
...
## 0. 边界
写：主链、U表、mermaid、≥3/=2、RoundSafeWait、TrustOrChallenge 入口文案、命数3烛 / PenaltyExtinguish1、lb_str_*。  
不写：左轮开枪、膛位推进、真弹/空膛随机、RoundWin、表外发明、入口真/假二键。  
仍锁：发5、MAX_PLAY=3、第一手不可质疑、Joker符合指定；pool / reveal 拍 **不变**；入口 doubt\|believe；hand-empty ≥3/=2。  
...
| U07 | Reveal | PenaltyExtinguish1 | 裁定为真（全符合宣称或 Joker）→ **质疑者熄 1 烛** | 真却让上家熄烛；仍走左轮开枪 | S18-2 / S18-17 |
| U08 | Reveal | PenaltyExtinguish1 | 裁定为假（存在非宣称且非 Joker）→ **上家（骗子）熄 1 烛** | 假却让质疑者熄烛；仍走左轮开枪 | S18-2 / S18-17 |
...
## 会签
负责人/UI/测试/鸿蒙/美术。合入≠终验。零ets（本票仅 docs；string 键可按需补）。
